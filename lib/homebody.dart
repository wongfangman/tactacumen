...
import 'package:tactacumen/allproductsscreen.dart';
import 'package:tactacumen/loadtype.dart';
import 'package:tactacumen/allproducts.dart';
                  ...
                  GestureDetector(
                      onTap: () => {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (content) => AllProductsScreen()))
                          },
                      child: Text("See More")),
                ],
              )),
