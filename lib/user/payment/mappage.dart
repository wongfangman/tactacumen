...
class _MapPageState extends State<MapPage> {
  ...
  static final CameraPosition _shopPosition = CameraPosition(
    target: LatLng(5.259524085838595, 100.47664168337533),
    zoom: 17,
  );
  ...
  void showShopMarker() {
    ...
    markers.add(Marker(
      markerId: markerId1,
      position: LatLng(5.259524085838595, 100.47664168337533),
      infoWindow: InfoWindow(
        title: 'Location',
        snippet: "Tact Acument (M) Sdn. Bhd.",
      ),
  ...
  double calculateDistance(lat1, lon1) {
    var lat2 = 5.259524085838595;
    var lon2 = 100.47664168337533;
